        ...
        return (
            <div className={`relative ${className}`} ref={dropdownRef}>
                ...
                >
                    ...
                    <ChevronDownIcon
                        className={`ml-1 h-4 w-4 text-zinc-400 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''
                            }`}
                    />
                </button>
                            ...
                            {filteredLanguages.length > 0 ? (
                                filteredLanguages.map((language) => (
                                    <button
                                        key={language.code}
                                        type="button"
                                        className={`w-full px-4 py-2 text-left text-sm hover:bg-zinc-100 focus:bg-zinc-100 focus:outline-none ${selectedLanguage === language.code
        ...
        <div className={`relative ${className}`} ref={dropdownRef}>
            ...
            >
                <span className="flex items-center">
                    <span className="text-xs text-zinc-500 mr-2">Language:</span>
                    <span>{selectedLang.name}</span>
                </span>
                <ChevronDownIcon
                    className={`ml-2 h-4 w-4 text-zinc-400 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''
                        }`}
                />
            </button>

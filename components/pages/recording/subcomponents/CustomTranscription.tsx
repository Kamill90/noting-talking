...
export const CustomTranscription = ({
  ...
  return (
    <div ref={ref} className="relative z-10 my-2 pl-3 sm:my-3">
      ...
      {disabled ? (
        <div className="rounded-lg bg-white p-3 font-normal text-zinc-700 sm:p-4">
        ...
        <div className="mt-2">
          <textarea
            ref={textAreaRef}
            className="w-full resize-none rounded-lg border border-zinc-300 bg-white p-3 font-normal leading-relaxed text-zinc-700 shadow-inner focus:border-transparent focus:outline-none focus:ring-2 focus:ring-zinc-500 sm:p-4"
